...
const int32_t	GAME_API_VERSION	= 3;
...
struct game_import_t
{
	...
	void	(*sound) (edict_t *ent, soundchannel_t channel, soundindex_t soundindex, vec_t volume, vec_t attenuation, vec_t timeofs);
	void	(*positioned_sound) (const vec3_t origin, edict_t *ent, soundchannel_t channel, soundindex_t soundindex, vec_t volume, vec_t attenuation, vec_t timeofs);
