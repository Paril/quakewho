...
const vec_t GRENADE_TIMER		= 3.0;
const vec_t GRENADE_MINSPEED	= 400;
const vec_t GRENADE_MAXSPEED	= 800;
...
void Blaster_Fire (edict_t *ent, vec3_t g_offset, int32_t damage, bool hyper, entity_effects_t effect)
{
	vec3_t	forward, right;
	vec3_t	start;
	vec3_t	offset;
